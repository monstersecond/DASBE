...
train_inputs, train_targets = \
    ds[0][0][:50000].reshape((1, 50000, 28, 28, 1)), ds[0][1][:50000].reshape((1, 50000, 1))
valid_inputs, valid_targets = \
    ds[0][0][50000:].reshape((1, 10000, 28, 28, 1)), ds[0][1][50000:].reshape((1, 10000, 1))
